...
abstract class BaseFragment<VB: ViewBinding>(private val inflate : Inflater<VB>): Fragment() {
    ...
    open fun setListeners(){} // for setting click listeners or observers
    open fun setBindings(){} // for things that must be applied to view binding
    open fun setObserverForEvent(){}
    open fun setObserverForState(){}
}